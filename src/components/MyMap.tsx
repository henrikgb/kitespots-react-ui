...
const MyMap = () => {
    return (
        <MapContainer className={"absolute z-0"} center={[58.80636404000909, 5.724361473212989]}
            ...
            />
            <Marker key="1" position={[59.02050003940309, 5.592325942611728]}
            ...
            <Marker key="2"  position={[58.88531361351894, 5.602662428854268]}
                    icon={new Icon({iconUrl: "pin.png", iconSize: [25, 41], iconAnchor: [12, 41]})} >
                <Popup>
            ...
            <Marker key="3"  position={[58.84227538997773, 5.560516132410946]}
                    icon={new Icon({iconUrl: "pin.png", iconSize: [25, 41], iconAnchor: [12, 41]})} >
                <Popup>
